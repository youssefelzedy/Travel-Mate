...
const UserSchema = new Schema(
  {
    fullname: {
      ...
      required: [
        true,
        { english: "Please add a name", arabic: "يرجى إضافة اسم" },
      ],
    },
    email: {
      type: String,
      required: [
        true,
        { english: "Please add a email", arabic: "يرجى إضافة بريد الكتروني" },
      ],
      unique: true,
      validate: [
        validator.isEmail,
    ...
    password: {
      ...
      required: [
        true,
        { english: "Please add a password", arabic: "يرجى إضافة كلمة المرور" },
      ],
      select: false,
    },
    passwordConfirm: {
